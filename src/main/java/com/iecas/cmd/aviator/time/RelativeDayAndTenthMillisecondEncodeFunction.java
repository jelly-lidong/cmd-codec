 ...
 * @since 2024-01-01
 */
public class RelativeDayAndTenthMillisecondEncodeFunction extends AbstractFunction {
     ...
     * 积0.1毫秒最大值（4字节无符号整数）
     */
    private static final long MAX_MILLISECONDS = (1L << (TENTH_MILLISECONDS_BYTES * 8)) - 1;

    /**
     * 构造函数
     */
    public RelativeDayAndTenthMillisecondEncodeFunction() {
        super();
    }
    ...
    public String getName() {
        return "relativeDayAndTenthMillisecond";
    }
     ...
     * @return 编码后的6字节整数值
     */
    private long calculateRelativeDayAndMillisecond(LocalDateTime baseDateTime, LocalDateTime targetDateTime) {
        // 计算积日（相对天数）
        ...
        return TimeUtil.mergeLong(days, DAYS_BYTES, milliseconds * 10, TENTH_MILLISECONDS_BYTES);
    }
}
